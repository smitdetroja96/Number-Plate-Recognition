...
PLATE_WIDTH_PADDING_FACTOR = 1.3 #changed by me -------------------------- initially 1.3 -------------------------------
PLATE_HEIGHT_PADDING_FACTOR = 1.6 #changed by me --------------------------intially 1.6 ---------------------------------
...
def detectPlatesInScene(imgOriginalScene):
    ...
    # imgThreshScene = np.zeros((height, width, 1), np.uint8) #changed by me
    ...
    cv2.imshow("GrayScene",imgGrayscaleScene)
...
def extractPlate(imgOriginal, listOfMatchingChars):
    ...
    intPlateWidth = 1 + int((listOfMatchingChars[len(listOfMatchingChars) - 1].intBoundingRectX + listOfMatchingChars[len(listOfMatchingChars) - 1].intBoundingRectWidth - listOfMatchingChars[0].intBoundingRectX) * PLATE_WIDTH_PADDING_FACTOR) #changed by me----------------------------------------------------------------------------------------------------------
    ...
    fltAverageCharHeight = (intTotalOfCharHeights * 2.5) / len(listOfMatchingChars)  #changed by me--------------------------------------------------------------------------------------

    intPlateHeight = int(fltAverageCharHeight * PLATE_HEIGHT_PADDING_FACTOR)#changed by me ------------------------------------------------------------------------------------------
